...
function restaurant_wp_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'restaurant_wp_custom_background_args', array(
...
function restaurant_wp_scripts() {
	...
	wp_enqueue_script( 'restaurant-wp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'restaurant-wp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
