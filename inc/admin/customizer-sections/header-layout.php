...
$wp_customize->add_section( $prefix . 'header_layout', array(
...
$wp_customize->add_control( $prefix . 'header_display', array(
...
$wp_customize->add_control( new Customize_Alpha_Color_Control( $wp_customize, $prefix . 'header_background_color', array(
