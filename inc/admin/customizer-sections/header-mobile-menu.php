...
$wp_customize->add_section( $prefix . 'mobile_menu', array(
	'title' => esc_html__( 'Mobile menu', 'restaurant-wp' ),
	'panel' => $prefix . 'panel_header',
) );

$wp_customize->add_setting( $prefix . 'mobile_menu_background_color', array(
	//		'type'    => 'option',
	'default'           => '#fff',
	'sanitize_callback' => 'sanitize_hex_color',
) );

$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . 'mobile_menu_background_color', array(
...
$wp_customize->add_setting( $prefix . 'mobile_menu_text_color', array(
	//		'type'    => 'option',
	'default'           => '#fff',
	'sanitize_callback' => 'sanitize_hex_color',
) );

$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . 'mobile_menu_text_color', array(
...
$wp_customize->add_setting( $prefix . 'mobile_menu_text_color_hover', array(
	//		'type'    => 'option',
	'default'           => '#fff',
	'sanitize_callback' => 'sanitize_hex_color',
) );

$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . 'mobile_menu_text_color_hover', array(
