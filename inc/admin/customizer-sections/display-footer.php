...
$wp_customize->add_section( $prefix . 'display_footer', array(
 ...
 */
$wp_customize->add_setting( $prefix . 'footer_background_image', array(
	'sanitize_callback' => 'restaurant_wp_callback',
) );

$wp_customize->add_control( new  WP_Customize_Media_Control( $wp_customize, $prefix . 'footer_background_image', array(
